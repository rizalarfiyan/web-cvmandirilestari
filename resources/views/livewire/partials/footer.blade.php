  ...
  <div class="relative z-10">
    <div class="w-full max-w-5xl px-4 xl:px-0 py-10 lg:pt-16 mx-auto">
      <div class="inline-flex items-center">
        <img src="{{ asset('assets/logo_sm.png') }}" alt="{{ config('app.name') }} Logo" class="text-base mx-auto size-12">
        <div class="border-s border-neutral-700 ps-5 ms-5">
          <p class="text-sm text-neutral-400">&#169; {{ now()->year }}. All rights reserved.</p>
        </div>
      </div>
    </div>
  </div>
