    ...
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
      <div class="lg:flex lg:items-start lg:gap-4">
        ...
        <div class="mt-6 w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs border bg-white p-6 rounded-lg shadow-smooth">
          ...
          @if(!empty($carts) && count($carts) > 0)
            <div class="space-y-3">
              <button type="button" class="flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                Bayar
              </button>
            </div>
          @endif
